...
from .autoencoders import SurfaceExtractors
...
class Hunyuan3DDiTPipeline:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        if getattr(self.model, "guidance_cond_proj_dim", None) is not None:
            ...
            guidance_cond = self.get_guidance_scale_embedding(guidance_scale_tensor, embedding_dim=self.model.guidance_cond_proj_dim).to(
    ...
    def _export(
        self, latents, output_type="trimesh", box_v=1.01, mc_level=0.0, num_chunks=20000, octree_resolution=256, mc_algo="mc", enable_pbar=True
    ):
